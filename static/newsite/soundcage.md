...
<figure>
    <img src="/static/img/soundcage/soundcageside.jpg" alt="SoundCage side view">
</figure>
...
<video width="100%" controls>
    <source src="/static/img/soundcage/soundcagevid.ogv" type="video/ogg"></source>
    <source src="/static/img/soundcage/soundcagevid.mp4" type="video/mp4"></source>
...
<span>
    <img width="49%" src="/static/img/soundcage/soundcageSensor1.png" alt="Ultrasound sensor part">
    <img width="49%" src="/static/img/soundcage/soundcageSensor2.png" alt="Ultrasound sensor installed">
</span>
...
<span>
    <img width="35%" src="/static/img/soundcage/transducer1.png" alt="Transducer part">
    <img width="64%" src="/static/img/soundcage/transducer2.png" alt="Transducer installed">
</span>
...
<span>
    ...
    <img width="50%" src="/static/img/soundcage/soundcageFrame.png" alt="SoundCage components">
</span>
