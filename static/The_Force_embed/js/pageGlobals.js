...
$( document ).ready(function()
{
  ...
  //min + ':' + sec
        ...
        .click( function(event) 
        {
            ...
            switch (event.target.id)
            {
                ...
                case "tex_keyboard":
                    ...
                    $("#"+whichSlot)
                        .attr('src', '/static/The_Force_embed/presets/previz/keyboard.png')
                        .animate(
                        {
                            backgroundColor: "rgba(255, 255, 255, 0.5)",
                        }, .250 );
                ...
                case "tex_audio":
                    ...
                    texture.globject =  gl.createTexture();
                    $("#"+whichSlot)
                        .attr('src', '/static/The_Force_embed/presets/previz/audio.png')
                        .animate(
                        {
                            backgroundColor: "rgba(255, 255, 255, 0.5)",
                        }, .250 );
                ...
                case "tex_noisebw":
                    ...
                    $("#"+whichSlot)
                        .attr('src', '/static/The_Force_embed/presets/previz/noisebw.png')
                        .animate(
                        {
                            backgroundColor: "rgba(255, 255, 255, 0.5)",
                        }, .250 );
    ...
    createNewVideoTexture(gl, "/static/The_Force_embed/starfield.mov", 0);   
