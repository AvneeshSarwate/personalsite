...
function createGlContext() {
    ...
    $.when($.ajax({ url: "/static/The_Force_embed/shaders/draw.vert", dataType: "text" }),
        $.ajax({ url: "/static/The_Force_embed/shaders/screen.vert", dataType: "text" }),
        $.ajax({ url: "/static/The_Force_embed/shaders/screen.frag", dataType: "text" }),
        $.ajax({ url: "/static/The_Force_embed/shaders/header.frag", dataType: "text" })).done(function(d, v, f, h) {
    ...
    testImage.src = "/static/The_Force_embed/images/test.jpg";
}
