...
//         tweets.push(searchTweets);
//         if(postTweetLoad && serverWorking){
//             postTweetLoad(searchTweets);
//         }
//     }
// }
...
var hardcodedVerses = [
["man what the heck is happening to this country", 'In the beginning God created the heaven and the earth.'],
["My cat is so stupid", 'And the earth was without form, and void; and darkness {was} upon the face of the deep. And the Spirit of God moved upon the face of the waters.'],
["How the fuck does my car always break down right when I need it to work", 'And God said, Let there be light: and there was light.']
];

bibleMatch = hardcodedVerses;
